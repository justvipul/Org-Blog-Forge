...
*  Features
** DONE Org-roam v2 compatible - ID-based bidirectional links

** DONE Automatic publishing - Git push → live site in 3 minutes

** DONE GitHub Actions CI/CD - Zero server maintenance

** DONE Custom themes - gray-theme + ReadTheOrg support

** DONE Responsive design - Mobile-friendly

** DONE Fast builds - Optimized for knowledge bases
...
** TODO Suggestions
** TODO make [[file:README.org][README]] just a landing page for all steps list.
** DONE [[file:notes/20260115215958-org_modern_test.org][org test file]]
** DONE results are populated in the public folder.
